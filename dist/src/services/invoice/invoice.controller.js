...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseGuards)(permission_guard_1.PermissionGuard),
    (0, permissions_decorator_1.RequirePermissions)('invoice', 'create'),
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(invoice_schema_1.createInvoiceSchema)),
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_validation_pipe_1.ZodValidationPipe(invoice_schema_1.updateInvoiceSchema)),
    __param(0, (0, common_1.Param)('id')),
